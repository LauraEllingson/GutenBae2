    ...
    <section className="w-full max-w-6xl mx-auto px-4 py-16 mt-10 mb-10">
      <div className="flex flex-col md:flex-row md:items-start md:gap-12 text-center md:text-left">
        ...
        <div className="flex-1 flex flex-col justify-end items-center md:items-start">
          <h3 className="text-lg font-semibold text-red-700 mb-4 text-center md:text-left w-full">
            Features:
          </h3>

          <div className="grid max-w-sm w-full h-full grid-cols-1 sm:grid-cols-2 md:grid-rows-3 gap-0 text-gray-700 text-sm font-fira self-end border border-gray-300">
            {[
              {
        ...
        {/* Right Side - Icon, Title, Paragraph */}
